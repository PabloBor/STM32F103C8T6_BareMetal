...
///////////////////////////////////////////////////////////
 typedef struct
 {
   ...
   __vo uint32_t SR1;     // 0x14  I2C Status register 1 (I2C_SR1)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
//                          SPECIFIC DEFINITIONS OF PERIPHERAL REGISTERS 
//                   (Base addresses of peripherals assigned to xxx_RedDef_t )
///////////////////////////////////////////////////////////////////////////////////////////////////
 // TODO: CHECAR
 ...
 #define SPI2_I2S     ((SPI_RegDef_t*) SPI2_I2S_BASEADRR)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// TODO: ver si estan bien los valores
// TODO: CHECAR
...
///////////////////////////////////////////////////////////
 ...
 #define SPI2_I2S_PCLK_EN()    ( RCC->APB1ENR |= (1 << 14) )
// #define SPI3_PCLK_EN()        ( RCC->APB1ENR |= (1 << 15) )
// #define SPI4_PCLK_EN()        ( RCC->APB2ENR |= (1 << 13) )
 
 #define SPI1_PCLK_DIS()        ( RCC->APB2ENR &= ~(1 << 12) )
 #define SPI2_I2S_PCLK_DIS()    ( RCC->APB1ENR &= ~(1 << 14) )
...
//                                       RETURN MACROS
///////////////////////////////////////////////////////////////////////////////////////////////////
// TODO: CAMBIAR PARA HACER MATCH CON LA CANTIDAD DE gpio DE LA PLACA
